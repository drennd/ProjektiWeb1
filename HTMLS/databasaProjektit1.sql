...
INSERT INTO `images` (`id`, `name`, `descrption`, `time`, `imgPath`) VALUES
(7, 'Flood in Detroit', 'During early morning there has been a flood that has covered the whole of detroit yes.\r\nIts stated that most buildings have been covered halfway but the residents have managed to escape  ,while rescue teams are attempting to control and confirm everyones ', '2024-02-02', 'uploads/Flood.jpg'),
(8, 'Tsunami in Japanese Shorelines', 'There has been a tsunami that hit the Japanese just after sudden minor shakes of the ground in hindsight a earthquake, Safety and rescue crews are out in the field to currently secure and find people that have been dragged in or that managed to be higher ', '2024-02-02', 'uploads/1.jpg'),
(9, 'Volcano Eruption from Island nearby Egypt', 'During midday Volcano has erupted slightly with magna storming down ,but due to previous volcanic eruptions there have been ditches made covered by obsidian which made it possible to not experience much damage to the surrounding area.', '2024-02-02', 'uploads/2.jpg');
